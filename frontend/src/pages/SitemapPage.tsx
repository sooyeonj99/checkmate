        ...
        <div className="container">
          ...
          <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: 12 }}>
              {[
                { label: '다크 모드', desc: '라이트 / 다크 / 시스템 설정 연동', badge: 'new' },
                { label: 'AI 챗봇', desc: '계약서 관련 질문 즉시 답변' },
                { label: '푸시 알림', desc: '만료 · 서명 요청 실시간 알림' },
                { label: '카메라 OCR', desc: '실물 계약서 촬영 후 텍스트 추출', badge: 'coming' },
              ].map(f => {
                  ...
                  <div key={f.label} style={{
                    ...
                    <div>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 4 }}>
                        <span style={{ fontSize: 16, fontWeight: 800, color: 'var(--text)' }}>{f.label}</span>
                        {b && (
